    ...
    println!(
        "txKernel xtask\n\n\
         Commands:\n\
           ...
           cargo xtask qemu --target rv64-qemu|rv64-m1dock-mock|la64-qemu --profile smoke|busybox [--dry-run] [--expect-sentinel] [--timeout-ms N] [--smp N] [--no-block] [--interactive] [--net none|user|tap:<ifname>|bridge:<bridge>] [--host-ping-guest IP]\n\
           ...
           cargo xtask shell-test --target rv64-qemu --script PATH [--group NAME[,NAME...]] [--list-groups] [--keep-going] [--parallel] [--jobs N] [--net none|user|tap:<ifname>|bridge:<bridge>]\n\
