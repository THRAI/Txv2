...
| Check ext4 Tier 1 live prerequisites without QEMU | `cargo xtask ext4 tier1 --preflight-live [--preflight-report PATH]` |
...
### `cargo xtask ext4 tier1 [--run-id RUN_ID] [--dry-run] [--preflight-live] [--preflight-report PATH] [--verify-receipt PATH]`
