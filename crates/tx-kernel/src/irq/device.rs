...
//!
//! The one-shot device binder validates and freezes the table before device
//! activation. The production trap top half dispatches this typed table first,
//! while the legacy IRQ table remains as a fallback for unmigrated devices.
