...
/// Operations supplied by structured file objects such as sockets.
///
/// Keeping this dispatch in the VFS-facing device layer lets generic
/// read/write and close paths operate without matching on network kinds.
