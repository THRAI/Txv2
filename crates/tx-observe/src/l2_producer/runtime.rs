...
use super::{HartLocalArray, HartLocalOptionArray};
use crate::l3_wire::encode;
use tx_hal::{CpuId, MonotonicCounterIf, ObserverIf, PercpuIf};
use tx_observe_types::{
    PayloadArgValue, PayloadCounterValue, PayloadDriveBegin, PayloadDriveEnd,
    PayloadMutationIndexCommit, PayloadMutationZoneSign, PayloadPhaseTransition,
    PayloadProcessGroup, PayloadProcessLabel, PayloadResume, PayloadStepOutcome,
    PayloadSyscallEnter, PayloadSyscallExit, PayloadWaitSourceNotify, PayloadYieldBegin,
    TxPayloadTag, TxTraceHartRing, TxTraceKind, TxTraceRecord, TxValueKind,
};
...
pub(super) const MAX_HARTS: usize = 64;
...
pub(super) struct HartSlot {
    /// Descriptor of this hart's ring region.
    pub(super) ring_desc: tx_hal::RingDescriptor,
    ...
    pub(super) span_counter: core::sync::atomic::AtomicU64,
}
...
pub(super) static HART_SLOTS: HartLocalArray<HartSlot, MAX_HARTS> =
...
pub(super) static EMITTERS: HartLocalOptionArray<HartEmitter, MAX_HARTS> =
    HartLocalOptionArray::new_none();
pub(super) static OBSERVE_ENABLED: AtomicBool = AtomicBool::new(true);
...
impl HartEmitter {
    ...
    fn emit(
        ...
        *rec = TxTraceRecord {
        ...
        super::dump::check_dump_threshold();
    }
}
...
#[inline]
pub(super) fn read_current_cpu_id() -> Option<CpuId> {
...
pub(crate) unsafe fn testing_reset(hart_idx: usize) {
    ...
    super::dump::testing_reset_dump_state();
