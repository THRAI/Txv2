...
use crate::linux_syscall::{
    ...
    MAP_SHARED, MAP_SHARED_VALIDATE, MCL_CURRENT, MCL_FUTURE, MCL_ONFAULT, MLOCK_ONFAULT,
    MPOL_DEFAULT, MPOL_F_MEMS_ALLOWED, MREMAP_FIXED, MREMAP_MAYMOVE, NR_FTRUNCATE,
    NR_GET_MEMPOLICY, NR_MADVISE, NR_MBIND, NR_MIGRATE_PAGES, NR_MINCORE, NR_MLOCK2, NR_MLOCKALL,
    NR_MMAP, NR_MOVE_PAGES, NR_MPROTECT, NR_MREMAP, NR_MUNLOCKALL, NR_MUNMAP, NR_PROCESS_MADVISE,
    NR_PROCESS_VM_READV, NR_PROCESS_VM_WRITEV, NR_REMAP_FILE_PAGES, NR_SET_MEMPOLICY, PROT_READ,
    PROT_WRITE,
};
