...
use crate::linux_syscall::{
    F_ADD_SEALS, F_GET_SEALS, F_SEAL_FUTURE_WRITE, F_SEAL_GROW, F_SEAL_SEAL, F_SEAL_SHRINK,
    F_SEAL_WRITE, MADV_DONTNEED, MAP_ANONYMOUS, MAP_FIXED, MAP_FIXED_NOREPLACE, MAP_PRIVATE,
    MAP_SHARED, MCL_CURRENT, MCL_FUTURE, MCL_ONFAULT, MFD_ALLOW_SEALING, MFD_CLOEXEC,
    MLOCK_ONFAULT, MPOL_DEFAULT, MPOL_F_MEMS_ALLOWED, MREMAP_FIXED, MREMAP_MAYMOVE, NR_FCNTL,
    NR_FTRUNCATE, NR_GET_MEMPOLICY, NR_MADVISE, NR_MBIND, NR_MEMFD_CREATE, NR_MIGRATE_PAGES,
    NR_MINCORE, NR_MLOCK2, NR_MLOCKALL, NR_MMAP, NR_MOVE_PAGES, NR_MPROTECT, NR_MREMAP,
    NR_MUNLOCKALL, NR_MUNMAP, NR_PIDFD_OPEN, NR_PROCESS_MADVISE, NR_PROCESS_VM_READV,
    NR_PROCESS_VM_WRITEV, NR_REMAP_FILE_PAGES, NR_SET_MEMPOLICY, NR_WRITE, PROT_READ, PROT_WRITE,
};
