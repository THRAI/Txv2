...
pub use numbers::{
    ...
    NR_MSGRCV, NR_MSGSND, NR_MSYNC, NR_MUNLOCK, NR_MUNLOCKALL, NR_MUNMAP, NR_NANOSLEEP,
    NR_NEWFSTATAT, NR_OPENAT, NR_PERSONALITY, NR_PIDFD_OPEN, NR_PIDFD_SEND_SIGNAL, NR_PIPE2,
    NR_PPOLL, NR_PREAD64, NR_PREADV, NR_PREADV2, NR_PRLIMIT64, NR_PROCESS_MADVISE,
    NR_PROCESS_VM_READV, NR_PROCESS_VM_WRITEV, NR_PWRITE64, NR_PWRITEV, NR_PWRITEV2, NR_READ,
    NR_READAHEAD, NR_READLINKAT, NR_READV, NR_RECVFROM, NR_REMAP_FILE_PAGES, NR_RENAMEAT2,
