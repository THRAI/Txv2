...
pub use numbers::{
    ...
    NR_CLOCK_GETRES, NR_CLOCK_GETTIME, NR_CLOCK_NANOSLEEP, NR_CLONE, NR_CLOSE, NR_CONNECT, NR_DUP,
    NR_DUP3, NR_EPOLL_CREATE1, NR_EPOLL_CTL, NR_EPOLL_PWAIT, NR_EPOLL_WAIT, NR_EVENTFD2, NR_EXECVE,
    NR_EXIT, NR_EXIT_GROUP, NR_FACCESSAT, NR_FACCESSAT2, NR_FCHDIR, NR_FCHMODAT, NR_FCHOWNAT,
    NR_FADVISE64, NR_FCNTL, NR_FDATASYNC, NR_FLOCK, NR_FSTAT, NR_FSTATFS, NR_FSYNC,
    NR_FTRUNCATE, NR_FUTEX,
    ...
    NR_NEWFSTATAT, NR_OPENAT, NR_PIDFD_OPEN, NR_PIDFD_SEND_SIGNAL, NR_PIPE2, NR_PPOLL, NR_PREAD64,
    NR_PREADV, NR_PRLIMIT64, NR_PSELECT6, NR_PSELECT6_TIME64, NR_PWRITE64, NR_PWRITEV, NR_READ,
    NR_READLINKAT, NR_READV, NR_RECVFROM, NR_RENAMEAT2, NR_RT_SIGACTION, NR_RT_SIGPENDING,
    ...
    NR_TIMERFD_GETTIME, NR_TIMERFD_SETTIME, NR_TIMER_CREATE, NR_TIMER_DELETE, NR_TIMER_GETOVERRUN,
    NR_TIMER_GETTIME, NR_TIMER_SETTIME, NR_TIMES, NR_TKILL, NR_TRUNCATE, NR_UMASK, NR_UMOUNT2,
    NR_UNAME, NR_UNLINKAT, NR_USERFAULTFD, NR_UTIMENSAT, NR_WAIT4, NR_WRITE, NR_WRITEV,
    O_ACCMODE, O_APPEND, O_CLOEXEC, O_CREAT, O_DIRECT, O_EXCL, O_NONBLOCK, O_RDONLY, O_RDWR,
    O_TRUNC, O_WRONLY, PROT_EXEC,
