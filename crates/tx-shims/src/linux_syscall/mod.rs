...
pub use numbers::{
    ...
    NR_IO_SETUP, NR_IO_SUBMIT, NR_IO_URING_ENTER, NR_IO_URING_SETUP, NR_KILL, NR_LINKAT, NR_LISTEN,
    NR_LSEEK, NR_MADVISE, NR_MBIND, NR_MEMFD_CREATE, NR_MIGRATE_PAGES, NR_MINCORE, NR_MKDIRAT,
    NR_MKNODAT, NR_MLOCK, NR_MLOCK2, NR_MLOCKALL, NR_MMAP, NR_MOUNT, NR_MOVE_PAGES, NR_MPROTECT,
