//! DesignWare MSHC (MMC/SD host controller) register definitions for the
//! StarFive JH7110 (VisionFive 2) SD card slot.
//!
//! Ported verbatim from Chronix (GPLv3):
//! <https://github.com/Chronix-OS/Chronix> `os/src/drivers/block/mmc/register.rs`.
//! Chronix in turn transcribed these from the DesignWare mobile-storage
//! register map and the Linux `dw_mmc` driver. This file is licensed GPLv3
//! per the upstream; see the workspace license notes.
#![allow(dead_code)]
