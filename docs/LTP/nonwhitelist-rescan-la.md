...
<!-- group 20 (endian_switch01,epoll-ltp,epoll_pwait01,float_iperb,force_erase.sh) rc=0 -->
...
<!-- group 180 (tst_ncpus,unzip01.sh,userfaultfd01,userns01,wait401) rc=0 -->
| tst_ncpus | 0 | ok |
| unzip01.sh | 0 | ok |
| userfaultfd01 | 0 | ok |
| userns01 | 0 | ok |
...
<!-- group 185 (waitid07,waitid08,waitpid07,waitpid11,wc01.sh) rc=0 -->
| wc01.sh | 0 | ok |
| waitid07 | - | notrun |
| waitid08 | - | notrun |
| waitpid07 | - | notrun |
...
<!-- group 190 (which01.sh,wireguard01.sh) rc=0 -->
| which01.sh | 0 | ok |
| wireguard01.sh | 0 | ok |
