...
<!-- group 825 (isofs.sh,kallsyms,kcmp03,kernbench,keyctl01) rc=0 -->
| isofs.sh | 0 | ok |
| kallsyms | 0 | ok |
| kernbench | 0 | ok |
| keyctl01 | 0 | ok |
...
<!-- group 835 (keyctl06,keyctl07,keyctl08,keyctl09,kill02) rc=0 -->
| keyctl06 | 0 | ok |
| keyctl07 | 0 | ok |
| keyctl08 | 0 | ok |
| keyctl09 | 0 | ok |
...
<!-- group 865 (ldd01.sh,leapsec01,lftest,lgetxattr01,lgetxattr02) rc=0 -->
| ldd01.sh | 0 | ok |
| leapsec01 | 0 | ok |
| lftest | 0 | ok |
| lgetxattr01 | 0 | ok |
...
<!-- group 875 (linktest.sh,listen01,listxattr01,listxattr02,listxattr03) rc=0 -->
| linktest.sh | 0 | ok |
| listen01 | 0 | ok |
| listxattr01 | 0 | ok |
| listxattr02 | 0 | ok |
...
<!-- group 880 (llistxattr01,llistxattr02,llistxattr03,ln_tests.sh,locktests) rc=0 -->
| llistxattr01 | 0 | ok |
| llistxattr02 | 0 | ok |
| llistxattr03 | 0 | ok |
| ln_tests.sh | 0 | ok |
...
| memcg_regression_test.sh | - | HANG |
| memcg_stat_rss.sh | - | notrun |
...
<!-- group 1065 (mq_notify02,mq_notify03,mqns_01,mqns_02,mqns_03) rc=124 -->
| mq_notify02 | 0 | ok |
| mq_notify03 | - | HANG |
| mqns_01 | - | notrun |
| mqns_02 | - | notrun |
| mqns_03 | - | notrun |
<!-- group 1065 超时(hang)->已恢复镜像 -->
...
<!-- group 1095 (munmap03,mv_tests.sh,myfunctions.sh,net_cmdlib.sh,netns_breakns.sh) rc=0 -->
| munmap03 | 0 | ok |
| mv_tests.sh | 0 | ok |
| myfunctions.sh | 0 | ok |
| net_cmdlib.sh | 0 | ok |
...
<!-- group 1130 (nm01.sh,nptl01,ns-echoclient,ns-icmp_redirector,ns-icmpv4_sender) rc=0 -->
| nm01.sh | 0 | ok |
| nptl01 | 0 | ok |
| ns-echoclient | 0 | ok |
...
<!-- group 1160 (openat201,openat202,openat203,openfile,open_tree01) rc=0 -->
| openat201 | 0 | ok |
| openat202 | 0 | ok |
| openat203 | 0 | ok |
| openfile | 0 | ok |
...
<!-- group 1270 (quotactl07,quotactl08,quotactl09,quota_remount_test01.sh,rcu_torture.sh) rc=0 -->
| quotactl07 | 0 | ok |
| quotactl08 | 0 | ok |
| quotactl09 | 0 | ok |
...
<!-- group 1355 (sched_getattr01,sched_getattr02,sched_setattr01,sched_setscheduler03,sched_stress.sh) rc=124 -->
| sched_getattr01 | 0 | ok |
| sched_getattr02 | 0 | ok |
| sched_setattr01 | 0 | ok |
| sched_setscheduler03 | 0 | ok |
| sched_stress.sh | - | HANG |
<!-- group 1355 超时(hang)->已恢复镜像 -->
...
<!-- group 1380 (send02,sendfile01.sh,sendfile07,sendfile07_64,sendfile09) rc=0 -->
| send02 | 4 | ok |
| sendfile01.sh | 0 | ok |
| sendfile07 | 0 | ok |
| sendfile07_64 | 0 | ok |
...
<!-- group 1585 (sync_file_range02,syncfs01,sysconf01,sysctl01,sysctl01.sh) rc=0 -->
...
<!-- group 1600 (sysinfo03,syslog11,syslog12,tar_tests.sh,tbio) rc=0 -->
| sysinfo03 | 0 | ok |
| syslog11 | 0 | ok |
| syslog12 | 0 | ok |
| tar_tests.sh | 0 | ok |
