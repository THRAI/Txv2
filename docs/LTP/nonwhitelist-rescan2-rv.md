...
<!-- group 0 (creat07_child,creat09,dynamic_debug01.sh,force_erase.sh,fs_bind04.sh) rc=0 -->
| creat07_child | 0 | ok |
| creat09 | 0 | ok |
...
| fs_bind_move09.sh | 9 | ok |
| fs_bind_move11.sh | 8 | ok |
| fs_bind_move12.sh | 7 | ok |
| fs_bind_move13.sh | - | HANG |
