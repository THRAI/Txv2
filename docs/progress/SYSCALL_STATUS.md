...
**Last refresh:** 2026-05-18 (recount after PR #30 + PR #31 — all 32
basic-musl OSComp tests passing on rv64-qemu; `rt_sigreturn` wired;
`cargo xtask syscall` introduced as the dispatch-table SSoT, with the
auto-maintained table at the bottom of this file regenerated by
