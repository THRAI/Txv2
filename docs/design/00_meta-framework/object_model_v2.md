...
- Exact guard-registration implementation (per-CPU tables, balanced nested-pin accounting, and drain budgets) belongs to EBR/Zone implementation, with architecture-facing rules already pinned by `EBR_ZONE_INTERFACE_v1.md` and `02_INVARIANTS_v5.md`.
