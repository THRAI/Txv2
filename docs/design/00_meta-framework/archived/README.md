# Archived Meta-Framework Docs

**Status.** Historical reference only.

These documents were moved out of the active meta-framework surface during the v4 unification pass. Their internal links may point at pre-unification filenames. Treat them as rationale and source history, not as current architecture.
