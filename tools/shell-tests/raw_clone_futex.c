// Clone test with futex synchronization
#include <stdio.h>
#include <string.h>
#include <errno.h>
#include <unistd.h>
...
static int child_fn(void *arg) {
    ...
    // Signal parent: child_done = 1; futex_wake
    child_done = 1;
...
int main(void) {
    ...
    *(void**)((char*)child_stack + 8) = (void*)0;
    ...
    // Wait for child: futex(FUTEX_WAIT, &child_done, 0)
    while (child_done == 0) {
        futex(&child_done, 0, 0, NULL);
    }
